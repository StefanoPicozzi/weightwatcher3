...
url <- "http://funktion-weightwatcher-default.vagrant.f8/"
...
factid <- factid+1
factjson <- '{ "userid" : 1, "obsdate" : "2016-06-20 07:15:00 EST", "obsname" : "weight", "obsvalue" : 80 }'
fact <- gsub("$(factid)", factid, fact, fixed=TRUE)
fact <- gsub("$(factname)", factname, fact, fixed=TRUE)
fact <- gsub("$(factjson)", factjson, fact, fixed=TRUE)
factbody <- paste(factbody, fact, sep=" ")
...
factname <- "Observation"
factid <- factid+1
factjson <- '{ "userid" : 1, "obsdate" : "2016-06-21 08:15:00 EST", "obsname" : "weight", "obsvalue" : 79 }'
fact <- gsub("$(factid)", factid, fact, fixed=TRUE)
fact <- gsub("$(factname)", factname, fact, fixed=TRUE)
fact <- gsub("$(factjson)", factjson, fact, fixed=TRUE)
factbody <- paste(factbody, fact, sep=" ")
...
factname <- "Observation"
factid <- factid+1
factjson <- '{ "userid" : 1, "obsdate" : "2016-06-22 09:15:00 EST", "obsname" : "weight", "obsvalue" : 78 }'
fact <- gsub("$(factid)", factid, fact, fixed=TRUE)
fact <- gsub("$(factname)", factname, fact, fixed=TRUE)
fact <- gsub("$(factjson)", factjson, fact, fixed=TRUE)
factbody <- paste(factbody, fact, sep=" ")
...
factname <- "Observation"
factid <- factid+1
factjson <- '{ "userid" : 1, "obsdate" : "2016-06-23 09:15:00 EST", "obsname" : "weight", "obsvalue" : 76 }'
fact <- gsub("$(factid)", factid, fact, fixed=TRUE)
fact <- gsub("$(factname)", factname, fact, fixed=TRUE)
fact <- gsub("$(factjson)", factjson, fact, fixed=TRUE)
factbody <- paste(factbody, fact, sep=" ")
